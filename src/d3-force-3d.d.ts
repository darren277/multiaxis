declare module 'd3-force-3d' {
    ...
    export function forceSimulation<Node, Link>(nodes: Node[], links?: Link[]): Simulation<Node, Link>;
    export function forceManyBody<Node>(options?: { strength?: number; theta?: number; distanceMin?: number; distanceMax?: number }): any;
