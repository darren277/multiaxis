const THREEJS_DRAWINGS = {
    ...
    'svg': () => import('./drawing/reusables/drawSvg.js').then(m => m.svgDrawing),
    'multisvg': () => import('./drawing/reusables/drawSvg.js').then(m => m.multiSvgDrawing),
    ...
    'gltf': () => import('./drawing/reusables/drawGLTF.js').then(m => m.gltfDrawing),
    ...
    'monitor': () => import('./drawing/reusables/drawMonitor.js').then(m => m.monitorDrawing),
    ...
    'exr': () => import('./drawing/reusables/drawEXR.js').then(m => m.exrDrawing),
    ...
    'familytree': () => import('./drawing/drawFamilyTree.js').then(m => m.familyTreeDrawing),
};
