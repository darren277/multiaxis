...
import { assert, assertString, assertObject, debugLog } from './assertUtils'
...
export async function contentLoadedCallback(
    ...
    const drawFuncsArray = Array.isArray(threeJSDrawing.drawFuncs)
    ...
    startRenderLoop(renderer, {
        ...
        css2DRenderer,
        css3DRenderer,
        css3DScene: css3DRenderer ? css3DScene : undefined,
        threejsDrawing: threeJSDrawing,
