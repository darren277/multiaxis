...
function importPointerLockControls() {
    return import('three/examples/jsm/controls/PointerLockControls.js').then(
        (module) => {
...
function importTrackballControls() {
    return import('three/examples/jsm/controls/TrackballControls.js').then(
        (module) => {
...
function importCSS3DRenderer() {
    return import('three/examples/jsm/renderers/CSS3DRenderer.js').then(
        (module) => {
...
function importCSS2DRenderer() {
    return import('three/examples/jsm/renderers/CSS2DRenderer.js').then(
        (module) => {
