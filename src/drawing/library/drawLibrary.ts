...
function createBookCases(
    ...
    for (let i = 0; i < caseCount; i++) {
        ...
        createBookCaseMesh(scene, threejsDrawing, {
            name: `book_case_1${String.fromCharCode(97 + i)}`, // e.g., 1a, 1b, 1c
            textureName:
                `bookcase${bookCaseI + 1}` as keyof typeof BOOK_CASE_TEXTURES,
            width: width,
            height: height,
            depth: depth,
...
function calculateNumberOfShelves(library: Library): number {
    ...
    const { numberOfRows, numberOfCases, spaceBetweenRows, spaceBetweenCases } =
        library
...
const DATA = {
    ...
    resources: [
        {
            name: 'Encyclopedia of Cognitive Science',
            ...
            personal_rating: 9.5,
            description:
                'A comprehensive overview of <strong>cognitive science</strong>, covering various aspects of the field.',
        },
        {
        ...
        },
        {
            ...
            personal_rating: 10,
            description:
                'A comprehensive series on algorithms and programming techniques.',
        },
        {
            ...
            personal_rating: 9.0,
            description:
                'An introduction to the theory of computation, including automata and complexity.',
        },
        {
        ...
        },
        {
            ...
            personal_rating: 8.0,
            description:
                'A guide to software development best practices and methodologies.',
        },
        {
            name: 'Clean Code',
        ...
        },
        {
            ...
            personal_rating: 9.0,
            description:
                'A guide to software design patterns and best practices.',
        },
    ],
}
...
function drawResources(
    ...
    sorted.forEach((resource, i) => {
        const { x, y, z } = calculatePositionOfResource(
            resource,
            library,
            row1StartX,
            row0StartZ,
    ...
    console.log(
        'Book-case centres X:',
        [...Array(DATA.library.numberOfCases).keys()].map((i) =>
            worldX(row1StartX, DATA.library, i),
        ),
    )
...
const libraryDrawing = {
    sceneElements: [],
    drawFuncs: [{ func: drawLibraryRoom, dataSrc: null }],
    eventListeners: {
        //'click': (event) => {},
        //'mousemove': (event) => {},
        keydown: (
    ...
    animationCallback: (
        ...
        if (
            ...
            console.warn(
                'No static boxes, moving meshes, or world meshes found.',
            )
            return
        }
