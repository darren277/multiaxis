    ...
    notesRaw.forEach(
        (msg: {
            ...
            if (msg.type === 'note_on' && msg.velocity > 0) {
                ...
                msg.type === 'note_off' ||
                (msg.type === 'note_on' && msg.velocity === 0)
            ) {
                // End of a note
                ...
                if (onTick !== undefined) {
                    ...
                    console.debug(
                        `pitch=${msg.note}, startSec=${startSec.toFixed(2)}, endSec=${endSec.toFixed(2)}`,
                    )
...
const musicDrawing = {
    sceneElements: [],
    drawFuncs: [{ func: drawMusic, dataSrc: 'music', dataType: 'json' }],
