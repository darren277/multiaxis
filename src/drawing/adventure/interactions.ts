...
// Event listeners...
function onAdventureKeyDown_BIDIRECTIONAL_ONLY(
...
function onAdventureKeyDown(
    ...
    if (nextStep)
        return goToStep(tweenGroup, camera, nextStep, adventureSteps, controls)
}
...
export { onClick, onAdventureKeyDown, onAdventureKeyDown_BIDIRECTIONAL_ONLY }
